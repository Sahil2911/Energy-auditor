...
- ~~**Scanned 21st/22nd papers.**~~ **Resolved 06 Sep for the 21st.** Rendered at
  170 dpi with PyMuPDF and read page by page; full inventory with answers in
  `question-bank/21st-sitting.md`. The 22nd gets the same treatment next and
  becomes the source for Mock 2. This had been carried as a standing risk since
  Day 1 with no date on it — the student asked for one, which was fair.
