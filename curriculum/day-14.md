...
> ### ⚠️ Correction, 06 Sep — this claim was wrong
>
> This paper was issued saying *"Every question here is unseen."* **Four of its
> eight questions had already been assigned:**
>
> | Slot | Question | Previously assigned as |
> |---|---|---|
> | **L-1** | 25th L-1, LP/HP boiler | **Day 1, Block B3** — verbatim |
> | L-2 | 16th L-1, heat pump | *unseen ✓* |
> | N-1 | 16th N-2, trigeneration | *unseen ✓* |
> | N-2 | 19th N-3, sawdust boiler | *unseen ✓* |
> | N-3 | 24th N-3, cooling tower | *unseen ✓* |
> | **N-4(A)** | 20th N-3, chiller changeover | **Sector diagnostic Q2** |
> | **N-4(B)** | 24th N-4(D), DRI steel | **Day 13, Block C** |
> | **N-4(C)** | 24th N-4(C), cement WHRB | **Day 13, Drill 68** — whose answers (14.49 MW, 382) are printed in `day-13.md` |
>
> **All three N-4 options were already assigned.** Two of them had been written by
> the same hand that then called them unseen, days earlier, with the reuse of
> N-4(A) recorded in a commit message. The claim was made from memory instead of
> from a check.
>
> **Effect on the score.** L-1 (5/5) and N-4(C) (17/20) were both seen, so 22 of
> the ~84 marks came from compromised questions. On the genuinely unseen material —
> Section I, L-2, N-1, N-2, N-3 — the score is **62/75 = 83%**, against 84% overall.
> **The rate is unchanged and the conclusion survives; the headline number was
> still inflated by construction.**
>
> **The guard:** `question-bank/used-ledger.md`, regenerated by
> `tools/ledger.py`, lists every question referenced anywhere in the repo. No
> question enters a future paper without being looked up there first.
